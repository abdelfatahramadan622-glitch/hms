...
@Component({
  ...
  styles: [`
    ...
    .error-icon-wrap {
      ...
      background: linear-gradient(135deg, #fef2f2, #fee2e2); display: grid; place-items: center;
      animation: pulseRing 2s ease-in-out infinite;
    }
    .error-icon-wrap i { font-size: 2.5rem; color: #ef4444; }
    ...
    .btn-back { background: #f3f4f6; color: #374151; border: 1px solid #e5e7eb !important; }
    ...
    @keyframes pulseRing { 0%, 100% { box-shadow: 0 0 0 0 rgba(239, 68, 68, 0.2); } 50% { box-shadow: 0 0 0 15px rgba(239, 68, 68, 0); } }
  `],
  template: `
    <div class="error-wrapper">
      <div class="error-card">
        ...
        <h2 class="error-title">غير مصرح بالوصول</h2>
        <p class="error-desc">ليس لديك صلاحية كافية للوصول إلى هذه الصفحة. يرجى التواصل مع مسؤول النظام.</p>
